 ...
 */
@Entity
@Table(name = "z_cus_sales", schema = "")
@SuppressWarnings("serial")
public class CusSalesEntity implements java.io.Serializable {
	/**主键*/
	...
	/**职务*/
	@Excel(name="职务",width=15,dicCode="position")
	...
	private java.lang.Double fcommission;
	/**备注*/
	...
	@Column(name ="FCOMMISSION",nullable=true,length=32)
	public java.lang.Double getFcommission(){
	 ...
	 */
	public void setFcommission(java.lang.Double fcommission){
