...
public class CustomEntity implements java.io.Serializable {
	...
	/**公司类型*/
	@Excel(name="公司类型",width=15,dicCode="company")
	...
	/**信用等级*/
	@Excel(name="信用等级",width=15,dicCode="credit")
	private java.lang.String fcredit;
	/**合同期始*/
	@Excel(name="合同期始",width=15,format = "yyyy-MM-dd")
	...
	@Column(name ="FTAXNO",nullable=true,length=32)
	...
	@Column(name ="FENNAME",nullable=true,length=32)
	...
	@Column(name ="FINANCE",nullable=true,length=32)
	...
	@Column(name ="FCREDIT",nullable=true,length=32)
	...
	@Column(name ="FKEY",nullable=true,length=32)
	...
	@Column(name ="FWEBSITE",nullable=true,length=32)
	...
	@Column(name ="FTAXRATE",nullable=true,length=32)
