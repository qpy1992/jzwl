...
<form class="form-horizontal" role="form" id="formobj" action="doorPointController.do?doUpdate" method="POST">
	<input type="hidden" id="btn_sub" class="btn_sub"/>
	<input type="hidden" id="id" name="id" value="${doorPointPage.id}"/>
	<fieldset>
		<legend>门点</legend>
		<div class="main-form">
			<div class="row">
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="fcode" value = "${doorPointPage.fcode}" type="text" class="form-control input-sm" maxlength="32"  ignore="ignore"  readonly/>
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
			            	<t:dictSelect field="fproject" defaultVal = "${doorPointPage.fproject}" type="select" hasLabel="false" title="项目组" extendJson="{class:'form-control input-sm'}"   typeGroupCode="project" ></t:dictSelect>
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="fname" value = "${doorPointPage.fname}" type="text" class="form-control input-sm" maxlength="32"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="fzxunit" value = "${doorPointPage.fzxunit}" type="text" class="form-control input-sm" maxlength="32"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
                <div class="bt-item col-md-6 col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-8 bt-content">
                            <textarea id="fnote" name="fnote" class="form-control input-sm" rows="6"  ignore="ignore" >${doorPointPage.fnote}</textarea>
                        </div>
                    </div>
                </div>
			</div>
		...
		<div class="tab-pane fade in active" id="dpcontact">  
			<div class="form-tb-toolbar">
	   		...
	   		<table class="table subinfo-table" id="dpcontact_table">
				...
				<tbody>
				<c:if test="${fn:length(doorPointPage.dpcontactList)  > 0 }">
				<c:forEach items="${doorPointPage.dpcontactList}" var="poVal" varStatus="stuts">
				<tr>
			  		<td class="form-ck">
			  			<input style="" type="checkbox" name="ck"/>
			  			<input name = "dpcontactList[${stuts.index }].id" value= "${poVal.id}" type="hidden"/>
			  		</td>
					<td>
							<input name="dpcontactList[${stuts.index }].fname" value = "${poVal.fname}" type="text" class="form-control input-sm" maxlength="32"  ignore="ignore"  />
					</td>
					<td>
			            	<t:dictSelect field="dpcontactList[${stuts.index }].fdefault" defaultVal = "${poVal.fdefault}" type="select" hasLabel="false" title="默认" extendJson="{class:'form-control input-sm'}"   typeGroupCode="sf_yn" ></t:dictSelect>
					</td>
					<td>
			            	<t:dictSelect field="dpcontactList[${stuts.index }].fsex" defaultVal = "${poVal.fsex}" type="select" hasLabel="false" title="性别" extendJson="{class:'form-control input-sm'}"   typeGroupCode="sex" ></t:dictSelect>
					</td>
					<td>
							<input name="dpcontactList[${stuts.index }].fphone" value = "${poVal.fphone}" type="text" class="form-control input-sm" maxlength="32"  ignore="ignore"  />
					</td>
					<td>
							<input name="dpcontactList[${stuts.index }].fmobile" value = "${poVal.fmobile}" type="text" class="form-control input-sm" maxlength="32"  datatype="m" ignore="ignore"  />
					</td>
					<td>
							<input name="dpcontactList[${stuts.index }].fax" value = "${poVal.fax}" type="text" class="form-control input-sm" maxlength="32"  ignore="ignore"  />
					</td>
			  	</tr>
				</c:forEach>
				</c:if>
