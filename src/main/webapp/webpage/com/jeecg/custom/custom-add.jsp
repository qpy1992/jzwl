...
<form class="form-horizontal" role="form" id="formobj" action="customController.do?doAdd" method="POST">
			...
			<div class="row">
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
			            	...
			            	<t:dictSelect field="ftype"  extendJson="{class:'i-checks'}" type="checkbox" hasLabel="false"  title="公司类型"  typeGroupCode="company" ></t:dictSelect>
			            	</div>
		            	</div>
					</div>
				</div>
				...
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="fabbr"  type="text" class="form-control input-sm" maxlength="32"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="ftaxno"  type="text" class="form-control input-sm" maxlength="32"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
				...
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="fenname"  type="text" class="form-control input-sm" maxlength="32"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="finance"  type="text" class="form-control input-sm" maxlength="32"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
			            	<t:dictSelect field="fcredit"  type="select" hasLabel="false" title="信用等级" extendJson="{class:'form-control input-sm'}"   typeGroupCode="credit" ></t:dictSelect>
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
		            		<div class="input-group input-group-sm">
		            			<input name="fstart" type="text" class="form-control input-sm laydate-date" value="<fmt:formatDate pattern='yyyy-MM-dd' type='date' value='${fstart}'/>"  ignore="ignore"  />
				...
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
		            		<div class="input-group input-group-sm">
		            			<input name="fend" type="text" class="form-control input-sm laydate-date" value="<fmt:formatDate pattern='yyyy-MM-dd' type='date' value='${fend}'/>"  ignore="ignore"  />
		            			<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
		            		</div>
		            	</div>
					</div>
				...
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-9 col-sm-9 col-xs-9 bt-content">
							<%--<input name="fcountry"  type="text" class="form-control input-sm" maxlength="32"  ignore="ignore"  />--%>
                            <input id="fcountry" name="fcountry" style="width: 300px" class="form-control" readonly type="text" value="上海市/上海市/宝山区" data-toggle="city-picker">
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="faddress"  type="text" class="form-control input-sm" maxlength="32"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="fzipcode"  type="text" class="form-control input-sm" maxlength="32"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
				...
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="fkey"  type="text" class="form-control input-sm" maxlength="32"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="fwebsite"  type="text" class="form-control input-sm" maxlength="32"  datatype="url" ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="femail"  type="text" class="form-control input-sm" maxlength="32"  datatype="e" ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="ftaxrate"  type="text" class="form-control input-sm" maxlength="32"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
			</div>
